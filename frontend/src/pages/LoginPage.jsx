        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 pt-5 border-t border-gray-100">
            ...
            <div className="grid grid-cols-3 gap-2">
              {[{ label: 'Admin', email: 'admin@company.com', pw: 'Admin@123' }, { label: 'Manager', email: 'manager@company.com', pw: 'Manager@123' }, { label: 'Employee', email: 'john.doe@company.com', pw: 'Emp@1234' }]
                .map(c => (
